  ...
  return (
    <div className="relative h-[500px] md:h-[600px] w-full overflow-hidden rounded-2xl shadow-2xl group">
      {images.map((img, index) => (
        ...
        >
          ...
          <Image
            ...
            priority={index === 0}
          />
          <div className="absolute bottom-0 left-0 right-0 p-8 z-20 text-white transform transition-all duration-500 translate-y-0">
            <h3 className="text-3xl md:text-4xl font-bold mb-3 drop-shadow-lg">
              {img.alt}
            </h3>
            <p className="text-lg text-neutral-200 max-w-2xl drop-shadow-md">
              {index === 0
      ...
      <button
        ...
        className="absolute left-4 top-1/2 -translate-y-1/2 z-30 p-3 rounded-full bg-white/10 backdrop-blur-md text-white border border-white/20 hover:bg-white hover:text-red-700 transition-all opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0"
      >
        <ChevronLeft className="w-6 h-6" />
      </button>
      <button
        onClick={goToNext}
        className="absolute right-4 top-1/2 -translate-y-1/2 z-30 p-3 rounded-full bg-white/10 backdrop-blur-md text-white border border-white/20 hover:bg-white hover:text-red-700 transition-all opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0"
      >
...
export default function Home() {
  ...
  const stats = [
    { icon: Users, value: '198k+', labelKey: 'home.stats.visitors', defaultLabel: 'Visitors' },
  ...
  const features = [
    ...
    { icon: Calendar, link: '/friends-day', titleKey: 'home.feature3_title', descKey: 'home.feature3_desc', color: 'bg-amber-50 text-amber-600' },
  ] as const

  const recentActivities = [
    { dateKey: 'home.activity1_date', titleKey: 'home.activity1_title', descKey: 'home.activity1_desc', image: img1 },
    { dateKey: 'home.activity2_date', titleKey: 'home.activity2_title', descKey: 'home.activity2_desc', image: img2 },
    { dateKey: 'home.activity3_date', titleKey: 'home.activity3_title', descKey: 'home.activity3_desc', image: img3 },
  ] as const
        ...
        <div className="container-custom mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-neutral-200 shadow-sm mb-8 animate-fade-in">
              ...
              <h1 className="text-5xl lg:text-7xl font-extrabold text-neutral-900 leading-tight mb-6 tracking-tight animate-slide-up">
                {String(t('home.hero_title', "Indian Penpals' League"))}
              </h1>

              <p className="text-xl lg:text-2xl text-neutral-600 mb-10 leading-relaxed max-w-2xl mx-auto lg:mx-0 animate-slide-up" style={{ animationDelay: '0.1s' }}>
              ...
              {/* Stats Row */}
              <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6 border-t border-neutral-200 pt-10">
                {stats.map((stat, idx) => {
                  const Icon = stat.icon
                  return (
                    <div key={idx} className="text-center lg:text-left">
                      <div className="flex items-center justify-center lg:justify-start gap-2 mb-1 text-red-700">
            ...
            {/* Carousel Content */}
            <div className="lg:w-1/2 w-full animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <ImageCarousel />
            </div>
          </div>
        </div>
        ...
        <div className="container-custom mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            <div>
              <h2 className="text-3xl font-bold text-neutral-900 mb-2">
                {String(t('home.recent_activities', 'Recent Activities'))}
              </h2>
              <p className="text-neutral-600">
                {String(t('home.recent_subtitle', 'Stay updated with our latest events and initiatives'))}
              </p>
            </div>
            <Link
              href="/news-events"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {recentActivities.map((activity, index) => (
              <div key={index} className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
